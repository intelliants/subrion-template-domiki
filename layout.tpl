		...
		<footer class="footer">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-5">
						{if $config.domiki_social}
							<ul class="social">
								{if $config.domiki_social_t}<li><a href="{$config.domiki_social_t}" class="twitter"><span class="fa fa-twitter-square"></span></a></li>{/if}
								{if $config.domiki_social_f}<li><a href="{$config.domiki_social_f}" class="facebook"><span class="fa fa-facebook-square"></span></a></li>{/if}
								{if $config.domiki_social_g}<li><a href="{$config.domiki_social_g}" class="google-plus"><span class="fa fa-google-plus-square"></span></a></li>{/if}
								{if $config.domiki_social_i}<li><a href="{$config.domiki_social_i}" class="linkedin"><span class="fa fa-linkedin-square"></span></a></li>{/if}
							</ul>
						{/if}
					</div>
				</div>
